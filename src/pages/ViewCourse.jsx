  ...
  return (
    <>
      <div className="relative flex min-h-[calc(100vh-3.5rem)]">
        <VideoDetailsSidebar setReviewModal={setReviewModal} setEditReviewData={setEditReviewData} />
      ...
      {reviewModal && <CourseReviewModal setReviewModal={setReviewModal} editReviewData={editReviewData} />}
    </>
  )
}
